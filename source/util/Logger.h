...
#define __LOG_NOARG(T, MSG)                                                     \
    invrm::Logger::getInstance()->logMessage(T, MSG)                            \
    
#define __LOG_1ARG(T, MSG, ARG)                                                 \
    invrm::Logger::getInstance()->logMessage(T, MSG, ARG)                       \

#define __LOG_2ARG(T, MSG, ARG1, ARG2)                                          \
    invrm::Logger::getInstance()->logMessage(T, MSG, ARG1, ARG2)                \

#define __LOG_3ARG(T, MSG, ARG1, ARG2, ARG3)                                    \
    invrm::Logger::getInstance()->logMessage(T, MSG, ARG1, ARG2, ARG3)          \
